...
Source: Clever Brand Guidelines - V7 AUG2025.pptx
Visible deck version: V6 - October 2024
...
- Category statement: Clever is the platform powering digital learning for schools.
- Mission: Connect every student to a world of learning.
- Current mission statement: Clever is on a mission to unlock new ways to learn for all students.
- Headline: Where digital learning works.
- Company description: We securely connect the data and applications that schools rely on to make digital learning work better, for everyone.
...
Primary:
- Clever blue: #1464FF, RGB 20, 100, 255. Primary corporate blue and logo color.
- White: #FFFFFF, RGB 255, 255, 255. Primary background and reversed logo fill.
- Dark navy: #0A1E46, RGB 10, 30, 70. Dark background and high-contrast brand field.

Secondary:
- Black: #1C1C1C, RGB 28, 28, 28. Text color only.
- Light blue: #DAEBFF, RGB 218, 235, 255. Light background fill.
- Yellow: #FFE478, RGB 255, 228, 120. Shape fill and tag color.
- Orange: #F78239, RGB 247, 130, 57. Shape fill and tag color.
- Green: #4ECC97, RGB 78, 204, 151. Shape fill and tag color.

Product UI:
- UI black: #1C1C1C. Product text and foreground.
- UI gray: #D3D6DE. Foreground support.
- UI light blue: #DAEBFF. Foreground support.
- UI periwinkle: #A8C9FF. Foreground support.
- UI navy: #0A1E46. Foreground support.
- Portal header blue: #1464FF. Always use for the portal header.
- UI green: #4ECC97. Foreground or alert color.
- UI orange: #F78239. Foreground support.
- UI yellow: #FFE478. Foreground support.
- Alert mint: #B8EBD5. Alert support color.
- Alert red: #CC2F2F. Alert color.
- Background gray: #C2C7D1. Product background.
- Background mist: #EBECF2. Product background.
- Background white-blue: #F4F8FF. Product background.

## Color Accessibility

- Dark navy #0A1E46: normal text OK #FFFFFF, #DAEBFF, #F78239, #FFE478; large text OK #FFFFFF, #DAEBFF, #F78239, #FFE478, #4ECC97; avoid #1464FF, #1C1C1C.
- White #FFFFFF: normal text OK #1C1C1C, #0A1E46; large text OK #1C1C1C, #0A1E46, #1464FF; avoid #DAEBFF, #4ECC97, #F78239, #FFE478.
- Light blue #DAEBFF: normal text OK #1C1C1C, #0A1E46; large text OK #1C1C1C, #0A1E46, #1464FF; avoid #FFFFFF, #4ECC97, #F78239, #FFE478.
